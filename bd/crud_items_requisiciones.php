...
$banderaFlete = (int)(isset($_POST['banderaFlete'])) ? $_POST['banderaFlete'] : '';
$banderaFisica = (int)(isset($_POST['banderaFisica'])) ? $_POST['banderaFisica'] : '';
$banderaResico = (int)(isset($_POST['banderaResico'])) ? $_POST['banderaResico'] : '';
