...
switch ($accion) {
    case 1:
        $consulta = "SELECT `presiones_id`,`presiones_nombre`, `presiones_alias`, `presiones_estatus`,`presiones_semana`,`presiones_dia`,`presiones_estatus` FROM `presiones` WHERE `presiones_obra` = " . $obra." ORDER BY presiones_nombre DESC";
